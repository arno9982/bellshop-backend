...
- `isAvailable` (booléen, par défaut true)
...
- `EN_PRODUCTION` : Fabrication en cours
...
PUT /api/orders/1/status?status=EN_PRODUCTION
...
| `isAvailable` | Boolean | Produit disponible à la vente |
